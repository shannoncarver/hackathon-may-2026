...
| Page | Tags | Summary |
|---|---|---|
| [aws-skill-credential-pattern](concepts/aws-skill-credential-pattern.md) | `aws`, `skills`, `iam`, `sso`, `product:cross-cutting` | LINQ-internal convention for how AWS-touching skills authenticate — named profiles, environment-derived defaults, prod guardrail, break-glass override, audit banner. Established by [Decision 0016](../../docs/decisions/0016-aws-multi-account-skill-credentials.md). |
...
| [Decision 0016 — AWS multi-account, multi-environment credential convention for skills](sources/decision-0016-aws-skill-credentials.md) | `aws`, `iam`, `sso`, `skills`, `architecture`, `decision-record`, `product:cross-cutting` | Internal decision record — seven rules governing named-profile credential resolution, environment-derived defaults, prod acknowledgment guardrail, fail-fast remediation, and one-SSO-session-per-day topology for all AWS-touching skills. |
