# Decision 0017 — Tool Search support: research folder
...
1. Start with the ADR: [`docs/decisions/0017-tool-search-support.md`](../../decisions/0017-tool-search-support.md). Locks the decision and the implementation contract.
